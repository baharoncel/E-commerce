...
def apply_real():
    ...
    items = [
        {
            "cat": cat_yuzuk,
            "filename": "real_mens_ring.jpg",
            "title": "Gümüş Paslanmaz Çelik Şövalye Erkek Yüzük",
            "price": Decimal("249.90"),
            "desc": "Stüdyo fotoğraf çekimiyle mat fırçalanmış gümüş çelik dokulu, maskülen şövalye model erkek yüzük."
        },
        {
            "cat": cat_bileklik,
            "filename": "real_mens_bracelet.jpg",
            "title": "Siyah Hakiki Deri & Çelik Erkek Bileklik",
            "price": Decimal("219.90"),
            "desc": "Gerçek çekim örgü hakiki siyah deri ve mıknatıslı çelik tokalı karizmatik erkek bileklik."
        },
        {
            "cat": cat_kolye,
            "filename": "real_mens_necklace.jpg",
            "title": "Çelik Mat Siyah Pusula Motifli Erkek Kolye",
            "price": Decimal("289.90"),
            "desc": "Gerçek fotoğraf çekimiyle siyah paslanmaz çelik madalyon ve pusula desenli çelik erkek kolye."
        },
        {
            "cat": cat_kupe,
            "filename": "real_mens_earrings.jpg",
            "title": "Siyah Çelik Mıknatıslı Halka Erkek Küpe Seti",
            "price": Decimal("159.90"),
            "desc": "Gerçek stüdyo çekimi deliksiz kulağa uygun mıknatıslı mat siyah çelik erkek küpe seti."
        },
        {
            "cat": cat_kol_dugmesi,
            "filename": "real_mens_cufflinks.jpg",
            "title": "Klasik Gümüş Kaplama Çelik Kol Düğmesi & Kravat İğnesi Seti",
            "price": Decimal("329.90"),
            "desc": "Stüdyo çekimi takım elbise ve gömlek şıklığı için klasik çizgi desenli kol düğmesi ve kravat iğnesi seti."
        }
    ]
    ...
    for item in items:
        ...
        ProductVariant.objects.create(
            product=product,
            sku=f"MALE-REAL-PHOTO-{product.id}",
            stock=50,
            price=item["price"]
        )
        print(f"Created Product ID: {product.id} - {product.title}")

    print("Successfully updated Men's Jewelry with REAL camera photos!")
