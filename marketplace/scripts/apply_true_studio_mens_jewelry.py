...
def apply():
    ...
    items = [
        {
            "cat": cat_yuzuk,
            "filename": "mens_jewelry_ring_studio.png",
        ...
        {
            "cat": cat_bileklik,
            "filename": "mens_jewelry_bracelet_studio.png",
        ...
        {
            "cat": cat_kolye,
            "filename": "mens_jewelry_necklace_studio.png",
        ...
        {
            "cat": cat_kupe,
            "filename": "mens_jewelry_earrings_studio.png",
        ...
        {
            "cat": cat_kol_dugmesi,
            "filename": "mens_jewelry_cufflinks_studio.png",
    ...
    for item in items:
        ...
        ProductVariant.objects.create(
            product=product,
            sku=f"MALE-TRUE-STUDIO-{product.id}",
            stock=50,
            price=item["price"]
        )
        print(f"Created Product ID: {product.id} - {product.title}")

    print("Successfully updated Men's Jewelry with 100% pure studio photos!")
